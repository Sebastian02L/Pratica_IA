...
namespace Assets.Scripts.SampleMind
{
    public class RandomMind : AbstractPathMind {
        ...
        public override Locomotion.MoveDirection GetNextMove(BoardInfo boardInfo, CellInfo currentPos, CellInfo[] goals) //recibe tres parametros, toda la informacion del tablero, posicion actual y posiciones meta
        {
