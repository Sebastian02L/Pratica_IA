...
namespace Assets.Scripts.DataStructures
{
    public class CellInfo : ICloneable
    {
        ...
        public CellInfo[] WalkableNeighbours(BoardInfo board)
        {
            ...
            //UP
            neighbours[0] = (this.RowId < (board.NumRows -1) && board.CellInfos[this.ColumnId, this.RowId + 1].Walkable) //comprueba si esta dentro del tablero y si es caminable
                ? board.CellInfos[this.ColumnId, this.RowId + 1] //si se cumple, guarda la celda superior
                : null;//sino, lo pone en null, osea que no puede ir a esa casilla.
            //Right
